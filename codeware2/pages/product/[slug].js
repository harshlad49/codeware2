        ...
        <div className="lg:w-4/5 mx-auto bg-slate-50 py-10 shadow-lg flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <div className="flex">
                <button onClick={() => {buyNow(slug, 1, product.price, product.title , size, product.color)}} className="flex ml-4 text-white bg-pink-500 border-0 px-2  py-2 md:px-3 focus:outline-none hover:bg-pink-600 rounded text-center"><ImPower className="m-1 text-4"/> Buy Now</button>
