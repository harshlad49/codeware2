  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form onSubmit={handleSubmit} className="space-y-6"  method="POST">
      <div>
        ...
        <div className="mt-2">
          <input id="email" onChange={handleChange} placeholder='Email Address' value={creadentials.email} name="email" type="email" autoComplete="email" required className="block w-full  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 placeholder:pl-1  focus:z-10 focus:ring-pink-600 sm:text-sm sm:leading-6"/>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mt-2">
          <input id="password" onChange={handleChange} placeholder='Password' value={creadentials.password} name="password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 placeholder:pl-1 focus:ring-2 focus:ring-inset focus:ring-pink-600 sm:text-sm sm:leading-6"/>
      ...
      <div className="flex text-sm">
            ...
            <a href={"/forgot"} className="font-semibold text-pink-600 hover:text-pink-500 pl-36">Forgot password?</a>
          </div>
      <div>
    ...
    <p className="mt-10 text-center text-sm text-gray-500">
      Not a member?
      <a href={"/singup"} className="font-semibold leading-6 text-pink-600 hover:text-pink-500">Create a account</a>
    </p>
  </div>
</div>
