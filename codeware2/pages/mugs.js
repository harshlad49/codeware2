...
const Mugs = ({products}) => {
  return (
    <div className='constainer  px-2 sm:m-auto items-center py-3  '>
      <section className="text-gray-600 body-font ">
        <div className=" pl-28 overflow-x-hidden py-10 mx-auto min-h-screen bg-slate-50  ">
          <div className="flex flex-wrap -m-4 items-center justify-center ">
          {Object.keys(products).length === 0 && <p>Sorry all thr Mugs are currently out of stock. New stock is coming soon!</p>}
